...
const Navbar = () => {
  ...
  const menu = (
    <Menu>
      <Menu.Item key="0">
        <Link to={"/redeem"}>
          <span className="text-[#ee8650] font-[Oswald] font-semibold uppercase">
            Redeem
          </span>
        </Link>
      </Menu.Item>
    ...
    <div className="border-b-[#2d2c2c] border-b-[2px]">
      <div className="grid grid-cols-12 my-10 md:mx-16 mx-8 font-[Montserrat]">
        <div className="col-span-4 flex gap-12 items-center justify-between">
          ...
          <Link to={"/redeem"}>
            <span className="text-[#ee8650] font-[Oswald] hidden md:block font-semibold uppercase">
              Redeem
            </span>
          </Link>
          <Link to={"/create-link"}>
          ...
          <div>
            <span
              className="text-[#ee8650] font-[Oswald] hidden md:block font-semibold uppercase cursor-pointer"
              onClick={handleOtherMenuToggle}
            >
              Other
            </span>
            <Popover
              ...
              placement="bottom"
            >
              <span className="text-[#ee8650] hidden md:block font-semibold uppercase cursor-pointer"></span>
            </Popover>
          </div>
        </div>
        ...
        <div className="col-span-3 flex items-center justify-end text-[#ee8650] text-sm md:text-base">
          ...
          <div className="p-2 rounded-md cursor-pointer ml-2 md:hidden">
            <Popover
              content={
                <div className="w-[250px]" onClick={() => setMenuOpen(false)}>
                  <div className="flex flex-col gap-3">
                    <Link to={"/redeem"}>
                      <span className="text-[#ee8650] font-semibold uppercase">
                        Redeem
                      </span>
                    </Link>
                    <Link to={"/create-link"}>
            ...
            >
              {isMenuOpen ? (
                <AiOutlineClose
                  ...
                  className="text-2xl text-[#C9FF28]"
                />
              ) : (
                <AiOutlineMenu
                  onClick={handleMenuToggle}
